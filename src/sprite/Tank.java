...
public abstract class Tank extends Sprite {
	...
	private Direction direction = Direction.UP; // направление,по умолчанию вверх
	protected Direction missileDirection = getDirection(); //геттер для напрвения
	...
	public Tank(ArrayList<Sprite> elements) {
		...
		setWhite();
		setImage(TANK_UP);
		BITMASK = Game.ENEMY_TANK_MASK; //дефолтные враги
	}
